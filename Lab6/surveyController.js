...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var action = readData("action");
        var other = readData("other");
         var favourite = readData("favourite");
        var feature = readData("feature");
        var ease = readData("ease");
        var comments = readData("comments")
        res.render('showResults', {results: [recommend,action,other,favourite,feature,ease,comments]});
        console.log([recommend,action,other,favourite,feature,ease,comments]);
    });
    ...
    app.post('/niceSurvey', urlencodedParser, function(req, res){
        ...
        for (var key in json){
            ...
            if ((key == "action") && (json[key].length === 2)){
